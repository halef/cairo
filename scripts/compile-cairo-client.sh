...
#/ Usage: bash compile-cairo-client.sh
#/ Description: Compiles cairo-client project and puts jars into `src/cairo/cairo-client/trunk/`
#/ Options:
...
if [[ "${BASH_SOURCE[0]}" = "$0" ]]; then
    cd ${SCRIPT_DIR}/../src/cairo/cairo-client/trunk/
