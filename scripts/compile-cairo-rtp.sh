...
#/ Usage: bash compile-cairo-rtp.sh
#/ Description: Compiles cairo-rtp project and puts jars into `src/cairo/cairo-rtp/trunk/`
#/ Options:
...
if [[ "${BASH_SOURCE[0]}" = "$0" ]]; then
    cd ${SCRIPT_DIR}/../src/cairo/cairo-rtp/trunk/
