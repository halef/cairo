...
public class RTPPlayer implements ControllerListener {
    ...
    public void controllerUpdate(ControllerEvent event) {
        synchronized (_lock) {
            ...
            if (event.toString().startsWith("javax.media.StartEvent[source=com.sun.media.processor.unknown.Handler")) {
    ...
    public void shutdown() {
        ...
        /* Some of the possible methods that may be needed for shutting down the rtp player
