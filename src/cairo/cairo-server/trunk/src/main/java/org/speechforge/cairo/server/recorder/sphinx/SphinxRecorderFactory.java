    ...
    public static ObjectPool createObjectPool(URL sphinxConfigURL, int instances)
      throws InstantiationException {
        ...
        if (_logger.isDebugEnabled()) {
            _logger.debug("AI:(SphinxRecorderFactory) creating new rec engine pool... instances: " + instances);
            _logger.debug("AI:(SphinxRecorderFactory) creating new rec engine pool... sphinxConfigURL: " + sphinxConfigURL);
        }
