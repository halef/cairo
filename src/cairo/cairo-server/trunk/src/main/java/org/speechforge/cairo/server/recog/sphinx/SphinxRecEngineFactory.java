...
public abstract class SphinxRecEngineFactory extends AbstractPoolableObjectFactory {
	...
	_logger.info("_sphinxConfigURL :" + _sphinxConfigURL);
    }
    ...
    public static ObjectPool createObjectPool(URL sphinxConfigURL, int instances)
      throws InstantiationException {
        ...
        if (_logger.isDebugEnabled()) {
            _logger.debug("AI:(SphinxRecEngineFactory) creating new rec engine pool... instances: " + instances);
            _logger.debug("AI:(SphinxRecEngineFactory) creating new rec engine pool... sphinxConfigURL: " + sphinxConfigURL);
        }
