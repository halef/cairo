	...
	class SpeechDataStreamer  extends Thread{
	    ...
	    private void showSignals(Data data) {
	        if (data instanceof SpeechStartSignal) {
	            ...
	            _logger.info("AI:server-Recorder: DataStartSignal encountered!");
	            infoDataStartSignal((DataStartSignal) data);
	        } else if (data instanceof DataEndSignal) {
	            _logger.info("AI:server-Recorder: DataEndSignal encountered!");
	        }
	    ...
	    private void stopRecordingData(Data data) {
	        ...
	        //String dumpFilePath = (System.getenv("ZANZIBAR_TEMP")==null ? "c:/temp/" : System.getenv("ZANZIBAR_TEMP")+"/");
	        ...
	        _logger.debug("v1. created audio Format Object "+wavFormat.toString());
	        _logger.debug("v1. filename:" + _uri);
